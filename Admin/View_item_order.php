...
<!-- Breadcrumb -->
<nav aria-label="breadcrumb" class="main-breadcrumb" style="margin-top:100px;">
        <ol class="breadcrumb">
   ...
   if($result=mysqli_query($link, $sql)){
	if(mysqli_num_rows($result) > 0){
        echo "<table class='table table-hover table-bordered' id='myTable' style='margin-top:120px;'>";
        echo "<div>";
        echo "<thread>" ;
            echo "<tr>";
